...
- Add SLIM (:class:`~lenskit.knn.SLIMScorer`).
...
- ``UnratedTrainingItemsCandidateSelector`` is deprecated in favor of
  :class:`~lenskit.basic.TrainingItemCandidateSelector` with default
  configuration.
